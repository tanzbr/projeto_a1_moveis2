...
class ExplorarScreenState extends State<ExplorarScreen> {
  ...
  void selecionarCategoria(String? cat) {
    if (!mounted) return;
    setState(() {
      _categoriaAtual = (cat != null && _categorias.contains(cat))
          ? cat
          : 'Todos';
    });
  }
    ...
    return Scaffold(
      ...
      body: ListenableBuilder(
        ...
        builder: (context, child) {
          final receitasFiltradas = _receitasFiltradas;
                  ...
                  children: [
                    Expanded(
                      child: DropdownButtonFormField<String>(
                        ...
                        items:
                            ['Todos', 'Até 10 min', 'Até 20 min', 'Até 30 min']
                                .map(
                                  (v) => DropdownMenuItem(
                                    value: v,
                                    child: Text(
